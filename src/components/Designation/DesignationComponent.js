...
//   keyword: yup.string().required('Designation is required'),
// });
...
//     try {
//       const response = await axios.get(`http://localhost:8080/api/search?keyword=${data.keyword}`);
...
//       setCurrentPage(1);
//     } catch (error) {
//       setErrorMessage('Failed to reload all designations.');
//     }
//   };
...
//         prev.filter((des) => des.masterDesignationId !== id)
//       );
...
//       <HeaderComponent />
//       <h2 className="text-primary mt-5 pt-5 main-content">Designation Management</h2>
...
//                   <td>{des.createdBy}</td>
//                   <td>
//                     <button className="action-button view-button me-2" onClick={() => handleView(des)}><FaEye /></button>
//                     <button className="action-button edit-button me-2" onClick={() => handleEdit(des)}><FaEdit /></button>
//                     <button className="action-button delete-button" onClick={() => handleDelete(des)}><FaTrash /></button>
//                   </td>
//                 </tr>
//               ))}
//             </tbody>
...
//               <button className="page-link" onClick={handlePrev} style={{ fontSize: '1.4rem', padding: '0.5rem 0.9rem' }} aria-label="Previous">
//                 <FaChevronLeft />
//               </button>
//             </li>
...
//               return (
//                 <li key={pageNumber} className={`page-item ${currentPage === pageNumber ? 'active' : ''}`} style={{ margin: '0 4px' }}>
//                   <button
...
//               <button className="page-link" onClick={handleNext} style={{ fontSize: '1.4rem', padding: '0.5rem 0.9rem' }} aria-label="Next">
//                 <FaChevronRight />
//               </button>
//             </li>
//           </ul>
...
//               Are you sure you want to delete the designation: <strong>{designationToDelete?.designationDescription}</strong>?
//             </div>
